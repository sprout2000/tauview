...
_LeafTauView is an experimental port of [LeafView](https://github.com/sprout2000/leafview#readme) (an Electron app) to Tauri. And while some performance gains have been made, not all of LeafView's functionality has yet been ported. In addition, platforms other than macOS are NOT supported._
